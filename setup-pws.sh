...
SCDF_SERVER_URL='http://repo.spring.io/libs-release/org/springframework/cloud/spring-cloud-dataflow-server-cloudfoundry/1.6.2.RELEASE/spring-cloud-dataflow-server-cloudfoundry-1.6.2.RELEASE.jar'
SCDF_SERVER_NAME='spring-cloud-dataflow-server-cloudfoundry-1.6.2.RELEASE.jar'
SCDF_SHELL_URL='http://repo.spring.io/release/org/springframework/cloud/spring-cloud-dataflow-shell/1.6.2.RELEASE/spring-cloud-dataflow-shell-1.6.2.RELEASE.jar'
SCDF_SHELL_NAME='spring-cloud-dataflow-shell-1.6.2.RELEASE.jar'
...
if [ ! -f server/$SCDF_SERVER_NAME ]; then
	...
	curl -o $SCDF_SERVER_URL -P server
fi
echo ""
